...
def plot_summary(
    ...
    health_scores = [
        max(0.0, 1.0 - report.anisotropy.score),
        min(1.0, report.dimensionality.utilization / 0.20),
    ]
